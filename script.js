...
var usersinfo;
if (localStorage.getItem("vaidate") == null) { usersinfo = []; }
else { usersinfo = JSON.parse(localStorage.getItem("vaidate")); }
signupBtn.addEventListener("click",function signUp() {
    userInputsValidation();
    Exist();
    if (userInputsValidation() == true && Exist() == false) {
        var user =
        {
        ...
        usersinfo.push(user)
        localStorage.setItem("vaidate", JSON.stringify(usersinfo));
